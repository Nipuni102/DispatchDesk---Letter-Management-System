...
const AccountsReg = () => {
  ...
  const fetchRecords = async () => {
    const url = "http://localhost:4000/api/accounts/getRegistered"
  ...
  return (
    <div className="AccountsReg-page">
      ...
      {/* Table */}
      <div className="AccountsReg-table-container">
        <table className="AccountsReg-table">
          <thead>
            <tr>
              <th>Date</th>
              <th>Ref No.</th>
