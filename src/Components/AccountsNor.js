...
const AccountsNor = () => {
  ...
  const fetchRecords = async () => {
    const url = "http://localhost:4000/api/accounts/getNormal"
  ...
  const handleSubmit = async () => {
    ...
    const url = "http://localhost:4000/api/accounts/actionTaken"; // Replace with your actual endpoint
    const payload = { 
  ...
  return (
    <div className="AccountsNor-page">
      {/* Full-width Header Bar */}
      <div className="header-bar">
        <h1>Accounts Section - Normal</h1>
      </div>
      ...
      {/* Table */}
      <div className="AccountsNor-table-container">
        <table className="AccountsNor-table">
          <thead>
            <tr>
              <th>Date</th>
              <th>Ref No.</th>
