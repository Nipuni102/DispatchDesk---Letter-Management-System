...
import "../styles/EstablishmentNor.css";
import axios from "axios";

const EstablishmentNor = () => {
  ...
  const fetchRecords = async () => {
    const url = "http://localhost:4000/api/establishment/getNormal"
  ...
  return (
    <div className="EstablishmentNor-page">
      {/* Full-width Header Bar */}
      <div className="header-bar">
        <h1>Establishment - Normal</h1>
      </div>
...
export default EstablishmentNor;
