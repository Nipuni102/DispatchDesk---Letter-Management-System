...
import "../styles/SurveyingReg.css";
...
const SurveyingReg = () => {
  ...
  const fetchRecords = async () => {
    const url = "http://localhost:4000/api/surveying/getRegistered"
  ...
  return (
    <div className="SurveyingReg-page">
      {/* Full-width Header Bar */}
      <div className="header-bar">
        <h1>Surveying Section - Registered Mails</h1>
      </div>
      ...
      {/* Table */}
      <div className="SurveyingReg-table-container">
        <table className="SurveyingReg-table">
          <thead>
            <tr>
              <th>Date</th>
              <th>Ref No.</th>
